...
export function winrateTimelineProgressPathForJobV1(jobId: string, cwd = process.cwd()): string | null {
...
function redactedEvent(event: WinrateTimelineProgressEventV1): WinrateTimelineProgressEventV1 {
  return {
    jobId: event.jobId,
